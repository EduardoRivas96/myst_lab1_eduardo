...
# Tickers de acciones contenidas en ETF-HACK

tk <- as.data.frame(read.xlsx( xlsxFile = "C:/Users/lalor/Desktop/Otoño 2018/TRADING/ITOT.xlsx",
...
# Obtener la frecuencia de las longitudes que mas se repiten

longs <- count(longitudes)



# Encontrar la que MAS se repíte
...
# *Balance*    : El valor del portafolio (Precio diario X Titulos + Capital).

# "Flotante"   : EL valor de los titulos por el precio sin capital (Precio diario x Titulos)
...
#--Calcular el Valor Flotante de la posición
Historico$Capital[1]<-Historico$Titulos_a[1]*Historico$Precio[1]
