...
Pesos_Titulos <- df_Portafolios[,-c(1,2,3)] 
...
tk <- as.data.frame(read.xlsx(file = "iShares-US-Insurance-ETF_fund.xls", 
...
setwd("~/Documents/MyST/Notas/Notas_AdminActiva") 
...
temp <- read.xlsx("iShares-US-Insurance-ETF_fund.xls", sheet = 1, colNames = F) 



 
temp <- read.xlsx("iShares-US-Insurance-ETF_fund.xls", sheet = 1) 



 
temp <- read.xlsx("iShares-US-Insurance-ETF_fund.xls") 



 
temp <- read.xlsx(file = "iShares-US-Insurance-ETF_fund.xls",sheetIndex = 1) 



 
temp <- read.xlsx(file = "iShares-US-Insurance-ETF_fund.csv") 



 
temp <- read.csv(file = "iShares-US-Insurance-ETF_fund.csv") 
...
temp <- read.csv(file = "IAK_holdings.csv") 



 
temp <- read.csv(file = "IAK_holdings.csv",header = T) 



 
temp <- read.csv(file = "IAK_holdings.csv",header = F) 
...
temp <- read.xlsx(file = "IAK_holdings.xlsx",sheetIndex = 1) 
...
temp <- read.xlsx(file = "IAK_holdings.xlsx",sheetIndex = 1,colIndex = 1, startRow = 12, endRow = 400) 
...
temp <- read.xlsx(file = "IAK_holdings.xlsx",sheetIndex = 1,colIndex = 1) 
...
ETF_Datos <- read.xlsx(file = "IAK_holdings.xlsx",sheetIndex = 1) 



 
Datos_ETF <- read.xlsx(file = "IAK_holdings.xlsx",sheetIndex = 1) 



 
which(Datos_ETF[,1] == "Ticker") 



 
tk  <- Datos_ETF[which(Datos_ETF[,1] == "Ticker"):length(Datos_ETF[,1]),] 
...
tk  <- Datos_ETF[which(Datos_ETF[,1] == "Ticker"):length(Datos_ETF[,1]),1] 



 
tk  <- as.character(Datos_ETF[which(Datos_ETF[,1] == "Ticker"):length(Datos_ETF[,1]),1]) 
...
tk  <- as.character(Datos_ETF[which(Datos_ETF[,1] == "Ticker")+1:length(Datos_ETF[,1]),1]) 
...
tk  <- na.omit(as.character(Datos_ETF[which(Datos_ETF[,1] == "Ticker")+1:length(Datos_ETF[,1]),1])) 
...
na.omit(as.character(Datos_ETF[which(Datos_ETF[,1] == "Ticker")+1:length(Datos_ETF[,1]),1])) 
...
tk  <- as.character(na.exclude(Datos_ETF[which(Datos_ETF[,1] == "Ticker")+1:length(Datos_ETF[,1]),1])) 
